...
get_filename_component(_filename "/home/aubailly/Bureau/WS_MOVE/src/scara_cpe_kinematics/srv/GoToXY.srv" NAME_WE)
add_custom_target(_scara_cpe_kinematics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "scara_cpe_kinematics" "/home/aubailly/Bureau/WS_MOVE/src/scara_cpe_kinematics/srv/GoToXY.srv" ""
)
...
_generate_srv_cpp(scara_cpe_kinematics
  "/home/aubailly/Bureau/WS_MOVE/src/scara_cpe_kinematics/srv/GoToXY.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_eus(scara_cpe_kinematics
  "/home/aubailly/Bureau/WS_MOVE/src/scara_cpe_kinematics/srv/GoToXY.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/scara_cpe_kinematics
)

### Generating Module File
_generate_module_eus(scara_cpe_kinematics
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/scara_cpe_kinematics
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(scara_cpe_kinematics_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(scara_cpe_kinematics_generate_messages scara_cpe_kinematics_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/aubailly/Bureau/WS_MOVE/src/scara_cpe_kinematics/srv/GoToXY.srv" NAME_WE)
add_dependencies(scara_cpe_kinematics_generate_messages_eus _scara_cpe_kinematics_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(scara_cpe_kinematics_geneus)
add_dependencies(scara_cpe_kinematics_geneus scara_cpe_kinematics_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS scara_cpe_kinematics_generate_messages_eus)
...
### Generating Services
_generate_srv_nodejs(scara_cpe_kinematics
  "/home/aubailly/Bureau/WS_MOVE/src/scara_cpe_kinematics/srv/GoToXY.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/scara_cpe_kinematics
)

### Generating Module File
_generate_module_nodejs(scara_cpe_kinematics
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/scara_cpe_kinematics
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(scara_cpe_kinematics_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(scara_cpe_kinematics_generate_messages scara_cpe_kinematics_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/aubailly/Bureau/WS_MOVE/src/scara_cpe_kinematics/srv/GoToXY.srv" NAME_WE)
add_dependencies(scara_cpe_kinematics_generate_messages_nodejs _scara_cpe_kinematics_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(scara_cpe_kinematics_gennodejs)
add_dependencies(scara_cpe_kinematics_gennodejs scara_cpe_kinematics_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS scara_cpe_kinematics_generate_messages_nodejs)
...
if(TARGET actionlib_msgs_generate_messages_cpp)
  add_dependencies(scara_cpe_kinematics_generate_messages_cpp actionlib_msgs_generate_messages_cpp)
endif()

if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/scara_cpe_kinematics)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/scara_cpe_kinematics
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(scara_cpe_kinematics_generate_messages_eus std_msgs_generate_messages_eus)
endif()
if(TARGET actionlib_msgs_generate_messages_eus)
  add_dependencies(scara_cpe_kinematics_generate_messages_eus actionlib_msgs_generate_messages_eus)
endif()
...
if(TARGET actionlib_msgs_generate_messages_lisp)
  add_dependencies(scara_cpe_kinematics_generate_messages_lisp actionlib_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/scara_cpe_kinematics)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/scara_cpe_kinematics
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(scara_cpe_kinematics_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
if(TARGET actionlib_msgs_generate_messages_nodejs)
  add_dependencies(scara_cpe_kinematics_generate_messages_nodejs actionlib_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/scara_cpe_kinematics)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/scara_cpe_kinematics\")")
  # install generated code
  install(
...
if(TARGET actionlib_msgs_generate_messages_py)
  add_dependencies(scara_cpe_kinematics_generate_messages_py actionlib_msgs_generate_messages_py)
endif()
