...
(cl:defmethod finished-val ((m <GoToXY-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scara_cpe_kinematics-srv:finished-val is deprecated.  Use scara_cpe_kinematics-srv:finished instead.")
  (finished m))
